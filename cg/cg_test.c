...
static void test_point_lt_1() {
    CGPoint point00 = point_new(0, 0);
    CGPoint point01 = point_new(0, 1);
    CGPoint point10 = point_new(1, 0);
    CGPoint point11 = point_new(1, 1);
    g_assert_cmpint(point_lt(point00, point01), ==, 1);
    g_assert_cmpint(point_lt(point00, point10), ==, 1);
    g_assert_cmpint(point_lt(point00, point11), ==, 1);
    g_assert_cmpint(point_lt(point01, point00), ==, 0);
    g_assert_cmpint(point_lt(point10, point00), ==, 0);
    g_assert_cmpint(point_lt(point11, point00), ==, 0);
    g_assert_cmpint(point_lt(point00, point00), ==, 0);
...
static void test_segment_lt_1() {
    CGPoint a = point_new(0, 0);
    CGPoint b = point_new(1, 1);
    CGPoint c = point_new(2, 2);
    CGSegment segment1 = segment_new(a, b);
    CGSegment segment2 = segment_new(a, c);
    CGSegment segment3 = segment_new(b, c);
    g_assert_cmpint(segment_lt(segment1, segment1), ==, 0);
    g_assert_cmpint(segment_lt(segment1, segment2), ==, 0);
    g_assert_cmpint(segment_lt(segment1, segment3), ==, 1);
    g_assert_cmpint(segment_lt(segment2, segment1), ==, 0);
    g_assert_cmpint(segment_lt(segment2, segment2), ==, 0);
    g_assert_cmpint(segment_lt(segment2, segment3), ==, 1);
    g_assert_cmpint(segment_lt(segment3, segment1), ==, 0);
    g_assert_cmpint(segment_lt(segment3, segment2), ==, 0);
    g_assert_cmpint(segment_lt(segment3, segment3), ==, 0);
    segment_release(segment1);
    segment_release(segment2);
    segment_release(segment3);
    point_release(a);
...
static void test_polygon_new_circle_1() {
    CGPoint center = point_new(1, 1);
    g_assert(polygon_new_circle(center, -1, 5) == NULL);
    g_assert(polygon_new_circle(center, 0, 5) == NULL);
    g_assert(polygon_new_circle(center, 1, 3) == NULL);
    point_release(center);
}

static void test_polygon_new_circle_2() {
    CGPoint center = point_new(1, 1);
    CGPolygon polygon = polygon_new_circle(center, 1, 4);
    g_assert(polygon != NULL);
    g_assert_cmpint(list_size(polygon->vertices), ==, 4);
...
static void test_polygon_dup_1() {
    ...
    g_assert(list_equals_cmp(polygon->vertices, dup->vertices, (int (*)(void *, void *)) point_equals));
    point_release(lower_left);
    polygon_release(polygon);
    polygon_release(dup);
}
...
static void test_polygon_vertices_1() {
    ...
    g_assert(list_equals_cmp(polygon->vertices, vertices, (int (*)(void *, void *)) point_equals));
    polygon_release(polygon);
    point_release(lower_left);
    list_full_release(vertices, (void (*)(void *)) point_release);
}
...
int main(int argc, char *argv[]) {
    ...
    g_test_add_func("/gc/vector_right_perpendicular_axis", test_vector_right_perpendicular_axis_1);
    g_test_add_func("/gc/vector_right_perpendicular_axis", test_vector_right_perpendicular_axis_2);
    g_test_add_func("/gc/vector_left_perpendicular_axis", test_vector_left_perpendicular_axis_1);
    g_test_add_func("/gc/vector_left_perpendicular_axis", test_vector_left_perpendicular_axis_2);
    ...
    g_test_add_func("/gc/point_lt", test_point_lt_1);
    ...
    g_test_add_func("/gc/segment_lt", test_segment_lt_1);
    ...
    g_test_add_func("/gc/polygon_new_circle", test_polygon_new_circle_1);
    g_test_add_func("/gc/polygon_new_circle", test_polygon_new_circle_2);
