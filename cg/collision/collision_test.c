...
static void test_circle_is_in_contact_with_circle_1() {
    ...
    g_assert_cmpint(circle_is_in_contact_with_circle(circle1, circle2), ==, 0);
...
static void test_circle_is_in_contact_with_circle_2() {
    CGPoint center1 = point_new(1, 1);
    CGCircle circle1 = circle_new(center1, 1);
...
static void test_circle_is_in_contact_with_circle_3() {
    CGPoint center1 = point_new(1, 1);
    CGCircle circle1 = circle_new(center1, 1);
    CGPoint center2 = point_new(3, 1);
    CGCircle circle2 = circle_new(center2, 1);
    g_assert_cmpint(circle_is_in_contact_with_circle(circle1, circle2), ==, 1);
    point_release(center1);
    point_release(center2);
    circle_release(circle1);
    circle_release(circle2);
...
static void test_circle_is_in_contact_with_circle_4() {
    CGPoint center1 = point_new(1, 1);
    CGCircle circle1 = circle_new(center1, 1);
...
static void test_circle_is_in_contact_with_circle_5() {
    CGPoint center1 = point_new(1, 1);
    CGCircle circle1 = circle_new(center1, 1);
    CGPoint center2 = point_new(3, 1);
    CGCircle circle2 = circle_new(center2, 1);
...
static void test_circle_is_in_contact_with_circle_6() {
    CGPoint center1 = point_new(1, 1);
    CGCircle circle1 = circle_new(center1, 1);
    CGPoint center2 = point_new(1, -1);
    CGCircle circle2 = circle_new(center2, 1);
...
static void test_polygon_is_colliding_with_circle_1() {
    CGPoint lower_left = point_new(0, 0);
    CGPolygon polygon = polygon_new_square(lower_left, 1);
    CGPoint center = point_new(3, 1);
    CGCircle circle = circle_new(center, 1);
    g_assert_cmpint(polygon_is_colliding_with_circle(polygon, circle), ==, 0);
    point_release(lower_left);
    point_release(center);
    polygon_release(polygon);
    circle_release(circle);
...
static void test_polygon_is_colliding_with_circle_2() {
    CGPoint lower_left = point_new(0, 0);
    CGPolygon polygon = polygon_new_square(lower_left, 2);
    CGPoint center = point_new(3, 1);
    CGCircle circle = circle_new(center, 1);
...
static void test_polygon_is_colliding_with_circle_3() {
    CGPoint lower_left = point_new(0, 0);
    CGPolygon polygon = polygon_new_square(lower_left, 2);
    CGPoint center = point_new(2, 1);
    CGCircle circle = circle_new(center, 1);
    g_assert_cmpint(polygon_is_colliding_with_circle(polygon, circle), ==, 1);
    point_release(lower_left);
    point_release(center);
    polygon_release(polygon);
    circle_release(circle);
...
static void test_polygon_is_colliding_with_circle_4() {
    CGPoint lower_left = point_new(0, 0);
    CGPolygon polygon = polygon_new_square(lower_left, 2);
...
static void test_polygon_is_colliding_with_circle_5() {
    CGPoint lower_left = point_new(0, 0);
    CGPolygon polygon = polygon_new_square(lower_left, 2);
    CGPoint center = point_new(0, 1);
    CGCircle circle = circle_new(center, 1);
    g_assert_cmpint(polygon_is_colliding_with_circle(polygon, circle), ==, 1);
    point_release(lower_left);
    point_release(center);
...
static void test_polygon_is_colliding_with_circle_6() {
    CGPoint lower_left = point_new(0, 0);
    CGPolygon polygon = polygon_new_square(lower_left, 2);
    CGPoint center = point_new(1, 0);
    CGCircle circle = circle_new(center, 1);
    g_assert_cmpint(polygon_is_colliding_with_circle(polygon, circle), ==, 1);
    point_release(lower_left);
    point_release(center);
...
static void test_circle_is_colliding_with_polygon_1() {
    CGPoint center = point_new(3, 1);
    CGCircle circle = circle_new(center, 1);
    CGPoint lower_left = point_new(0, 0);
    CGPolygon polygon = polygon_new_square(lower_left, 1);
    g_assert_cmpint(circle_is_colliding_with_polygon(circle, polygon), ==, 0);
    point_release(lower_left);
    point_release(center);
    polygon_release(polygon);
    circle_release(circle);
...
static void test_circle_is_colliding_with_polygon_2() {
    CGPoint center = point_new(3, 1);
    CGCircle circle = circle_new(center, 1);
    CGPoint lower_left = point_new(0, 0);
    CGPolygon polygon = polygon_new_square(lower_left, 2);
...
static void test_circle_is_colliding_with_polygon_3() {
    CGPoint center = point_new(2, 1);
    CGCircle circle = circle_new(center, 1);
    CGPoint lower_left = point_new(0, 0);
    CGPolygon polygon = polygon_new_square(lower_left, 2);
    g_assert_cmpint(circle_is_colliding_with_polygon(circle, polygon), ==, 1);
    point_release(lower_left);
    point_release(center);
    polygon_release(polygon);
    circle_release(circle);
...
static void test_circle_is_colliding_with_polygon_4() {
    CGPoint center = point_new(1, 2);
    CGCircle circle = circle_new(center, 1);
    CGPoint lower_left = point_new(0, 0);
    CGPolygon polygon = polygon_new_square(lower_left, 2);
...
static void test_circle_is_colliding_with_polygon_5() {
    CGPoint center = point_new(0, 1);
    CGCircle circle = circle_new(center, 1);
    CGPoint lower_left = point_new(0, 0);
    CGPolygon polygon = polygon_new_square(lower_left, 2);
...
static void test_circle_is_colliding_with_polygon_6() {
    CGPoint center = point_new(1, 0);
    CGCircle circle = circle_new(center, 1);
    CGPoint lower_left = point_new(0, 0);
    CGPolygon polygon = polygon_new_square(lower_left, 2);
...
static void test_circle_is_colliding_with_circle_1() {
    CGPoint center1 = point_new(1, 1);
    CGCircle circle1 = circle_new(center1, 1);
    CGPoint center2 = point_new(4, 1);
    CGCircle circle2 = circle_new(center2, 1);
    g_assert_cmpint(circle_is_colliding_with_circle(circle1, circle2), ==, 0);
    point_release(center1);
    point_release(center2);
    circle_release(circle1);
    circle_release(circle2);
...
static void test_circle_is_colliding_with_circle_2() {
    CGPoint center1 = point_new(1, 1);
    CGCircle circle1 = circle_new(center1, 1);
    CGPoint center2 = point_new(3, 1);
    CGCircle circle2 = circle_new(center2, 1);
...
static void test_circle_is_colliding_with_circle_3() {
    CGPoint center1 = point_new(1, 1);
    CGCircle circle1 = circle_new(center1, 1);
    CGPoint center2 = point_new(2, 1);
    CGCircle circle2 = circle_new(center2, 1);
    g_assert_cmpint(circle_is_colliding_with_circle(circle1, circle2), ==, 1);
    point_release(center1);
    point_release(center2);
    circle_release(circle1);
    circle_release(circle2);
...
static void test_circle_is_colliding_with_circle_4() {
    CGPoint center1 = point_new(1, 1);
    CGCircle circle1 = circle_new(center1, 1);
...
static void test_circle_is_colliding_with_circle_5() {
    CGPoint center1 = point_new(1, 1);
    CGCircle circle1 = circle_new(center1, 1);
    CGPoint center2 = point_new(0, 1);
    CGCircle circle2 = circle_new(center2, 1);
    g_assert_cmpint(circle_is_colliding_with_circle(circle1, circle2), ==, 1);
    point_release(center1);
    point_release(center2);
...
static void test_circle_is_colliding_with_circle_6() {
    CGPoint center1 = point_new(1, 1);
    CGCircle circle1 = circle_new(center1, 1);
    CGPoint center2 = point_new(1, 0);
    CGCircle circle2 = circle_new(center2, 1);
    g_assert_cmpint(circle_is_colliding_with_circle(circle1, circle2), ==, 1);
    point_release(center1);
    point_release(center2);
...
static void test_polygon_point_of_contact_with_circle_1() {
    CGPoint lower_left = point_new(0, 0);
    CGPolygon polygon = polygon_new_square(lower_left, 2);
    CGPoint center = point_new(4, 1);
    CGCircle circle = circle_new(center, 1);
    g_assert(polygon_point_of_contact_with_circle(polygon, circle) == NULL);
    point_release(lower_left);
    point_release(center);
    polygon_release(polygon);
    circle_release(circle);
...
static void test_polygon_point_of_contact_with_circle_2() {
    CGPoint lower_left = point_new(0, 0);
    CGPolygon polygon = polygon_new_square(lower_left, 2);
    CGPoint center = point_new(2, 1);
    CGCircle circle = circle_new(center, 1);
...
static void test_polygon_point_of_contact_with_circle_3() {
    CGPoint lower_left = point_new(0, 0);
    CGPolygon polygon = polygon_new_square(lower_left, 2);
    CGPoint center = point_new(3, 1);
    CGCircle circle = circle_new(center, 1);
    CGPoint point_of_contact = polygon_point_of_contact_with_circle(polygon, circle);
    g_assert(double_equals(point_x(point_of_contact), 2));
    g_assert(double_equals(point_y(point_of_contact), 1));
    point_release(point_of_contact);
    point_release(lower_left);
...
static void test_polygon_point_of_contact_with_circle_4() {
    CGPoint lower_left = point_new(0, 0);
    CGPolygon polygon = polygon_new_square(lower_left, 2);
    CGPoint center = point_new(1, 3);
    CGCircle circle = circle_new(center, 1);
...
static void test_polygon_point_of_contact_with_circle_5() {
    CGPoint lower_left = point_new(0, 0);
    CGPolygon polygon = polygon_new_square(lower_left, 2);
    CGPoint center = point_new(-1, 1);
    CGCircle circle = circle_new(center, 1);
...
static void test_polygon_point_of_contact_with_circle_6() {
    CGPoint lower_left = point_new(0, 0);
    CGPolygon polygon = polygon_new_square(lower_left, 2);
    CGPoint center = point_new(1, -1);
    CGCircle circle = circle_new(center, 1);
...
static void test_circle_point_of_contact_with_polygon_1() {
    CGPoint center = point_new(4, 1);
    CGCircle circle = circle_new(center, 1);
    CGPoint lower_left = point_new(0, 0);
    CGPolygon polygon = polygon_new_square(lower_left, 2);
    g_assert(circle_point_of_contact_with_polygon(circle, polygon) == NULL);
    point_release(lower_left);
    point_release(center);
    polygon_release(polygon);
    circle_release(circle);
...
static void test_circle_point_of_contact_with_polygon_2() {
    CGPoint center = point_new(2, 1);
    CGCircle circle = circle_new(center, 1);
    CGPoint lower_left = point_new(0, 0);
    CGPolygon polygon = polygon_new_square(lower_left, 2);
...
static void test_circle_point_of_contact_with_polygon_3() {
    CGPoint center = point_new(3, 1);
    CGCircle circle = circle_new(center, 1);
    CGPoint lower_left = point_new(0, 0);
    CGPolygon polygon = polygon_new_square(lower_left, 2);
    CGPoint point_of_contact = circle_point_of_contact_with_polygon(circle, polygon);
    g_assert(double_equals(point_x(point_of_contact), 2));
    g_assert(double_equals(point_y(point_of_contact), 1));
    point_release(point_of_contact);
    point_release(lower_left);
...
static void test_circle_point_of_contact_with_polygon_4() {
    CGPoint center = point_new(1, 3);
    CGCircle circle = circle_new(center, 1);
    CGPoint lower_left = point_new(0, 0);
    CGPolygon polygon = polygon_new_square(lower_left, 2);
...
static void test_circle_point_of_contact_with_polygon_5() {
    CGPoint center = point_new(-1, 1);
    CGCircle circle = circle_new(center, 1);
    CGPoint lower_left = point_new(0, 0);
    CGPolygon polygon = polygon_new_square(lower_left, 2);
...
static void test_circle_point_of_contact_with_polygon_6() {
    CGPoint center = point_new(1, -1);
    CGCircle circle = circle_new(center, 1);
    CGPoint lower_left = point_new(0, 0);
    CGPolygon polygon = polygon_new_square(lower_left, 2);
...
static void test_circle_minimum_translation_vector_with_circle_1() {
    CGPoint center1 = point_new(1, 1);
    CGCircle circle1 = circle_new(center1, 1);
    CGPoint center2 = point_new(4, 1);
    CGCircle circle2 = circle_new(center2, 1);
    CGVector axis = vector_new(1, 0);
    CGVector mtv = circle_minimum_translation_vector_with_circle(circle1, circle2, axis);
...
static void test_circle_minimum_translation_vector_with_circle_2() {
    CGPoint center1 = point_new(1, 1);
    CGCircle circle1 = circle_new(center1, 1);
    CGPoint center2 = point_new(3, 1);
    CGCircle circle2 = circle_new(center2, 1);
...
static void test_circle_minimum_translation_vector_with_circle_3() {
    CGPoint center1 = point_new(1, 1);
    CGCircle circle1 = circle_new(center1, 1);
    CGPoint center2 = point_new(1, 1);
    CGCircle circle2 = circle_new(center2, 1);
    ...
    CGVector mtv = circle_minimum_translation_vector_with_circle(circle1, circle2, axis);
    g_assert(double_equals(vector_x(mtv), sqrt(2)));
    g_assert(double_equals(vector_y(mtv), sqrt(2)));
    vector_release(mtv);
    vector_release(axis);
    point_release(center1);
    point_release(center2);
...
static void test_circle_minimum_translation_vector_with_circle_4() {
    CGPoint center1 = point_new(1, 1);
    CGCircle circle1 = circle_new(center1, 1);
    CGPoint center2 = point_new(2, 1);
    CGCircle circle2 = circle_new(center2, 1);
...
static void test_circle_minimum_translation_vector_with_circle_5() {
    CGPoint center1 = point_new(1, 1);
    CGCircle circle1 = circle_new(center1, 1);
    CGPoint center2 = point_new(2, 1);
    CGCircle circle2 = circle_new(center2, 1);
...
int main(int argc, char *argv[]) {
    ...
    g_test_add_func("/gc/circle_is_in_contact_with_circle",
                    test_circle_is_in_contact_with_circle_1);
    g_test_add_func("/gc/circle_is_in_contact_with_circle",
                    test_circle_is_in_contact_with_circle_2);
    g_test_add_func("/gc/circle_is_in_contact_with_circle",
                    test_circle_is_in_contact_with_circle_3);
    g_test_add_func("/gc/circle_is_in_contact_with_circle",
                    test_circle_is_in_contact_with_circle_4);
    g_test_add_func("/gc/circle_is_in_contact_with_circle",
    ...
    g_test_add_func("/gc/polygon_is_colliding_with_circle",
                    test_polygon_is_colliding_with_circle_1);
    g_test_add_func("/gc/polygon_is_colliding_with_circle",
                    test_polygon_is_colliding_with_circle_2);
    g_test_add_func("/gc/polygon_is_colliding_with_circle",
                    test_polygon_is_colliding_with_circle_3);
    g_test_add_func("/gc/polygon_is_colliding_with_circle",
                    test_polygon_is_colliding_with_circle_4);
    g_test_add_func("/gc/polygon_is_colliding_with_circle",
                    test_polygon_is_colliding_with_circle_5);
    g_test_add_func("/gc/polygon_is_colliding_with_circle",
                    test_polygon_is_colliding_with_circle_6);
    g_test_add_func("/gc/circle_is_colliding_with_polygon",
                    test_circle_is_colliding_with_polygon_1);
    g_test_add_func("/gc/circle_is_colliding_with_polygon",
                    test_circle_is_colliding_with_polygon_2);
    g_test_add_func("/gc/circle_is_colliding_with_polygon",
                    test_circle_is_colliding_with_polygon_3);
    g_test_add_func("/gc/circle_is_colliding_with_polygon",
                    test_circle_is_colliding_with_polygon_4);
    g_test_add_func("/gc/circle_is_colliding_with_polygon",
                    test_circle_is_colliding_with_polygon_5);
    g_test_add_func("/gc/circle_is_colliding_with_polygon",
                    test_circle_is_colliding_with_polygon_6);
    g_test_add_func("/gc/circle_is_colliding_with_circle",
                    test_circle_is_colliding_with_circle_1);
    g_test_add_func("/gc/circle_is_colliding_with_circle",
                    test_circle_is_colliding_with_circle_2);
    g_test_add_func("/gc/circle_is_colliding_with_circle",
                    test_circle_is_colliding_with_circle_3);
    g_test_add_func("/gc/circle_is_colliding_with_circle",
                    test_circle_is_colliding_with_circle_4);
    g_test_add_func("/gc/circle_is_colliding_with_circle",
                    test_circle_is_colliding_with_circle_5);
    g_test_add_func("/gc/circle_is_colliding_with_circle",
                    test_circle_is_colliding_with_circle_6);
    ...
    g_test_add_func("/gc/polygon_point_of_contact_with_circle",
                    test_polygon_point_of_contact_with_circle_1);
    g_test_add_func("/gc/polygon_point_of_contact_with_circle",
                    test_polygon_point_of_contact_with_circle_2);
    g_test_add_func("/gc/polygon_point_of_contact_with_circle",
                    test_polygon_point_of_contact_with_circle_3);
    g_test_add_func("/gc/polygon_point_of_contact_with_circle",
                    test_polygon_point_of_contact_with_circle_4);
    g_test_add_func("/gc/polygon_point_of_contact_with_circle",
                    test_polygon_point_of_contact_with_circle_5);
    g_test_add_func("/gc/polygon_point_of_contact_with_circle",
                    test_polygon_point_of_contact_with_circle_6);
    g_test_add_func("/gc/circle_point_of_contact_with_polygon",
                    test_circle_point_of_contact_with_polygon_1);
    g_test_add_func("/gc/circle_point_of_contact_with_polygon",
                    test_circle_point_of_contact_with_polygon_2);
    g_test_add_func("/gc/circle_point_of_contact_with_polygon",
                    test_circle_point_of_contact_with_polygon_3);
    g_test_add_func("/gc/circle_point_of_contact_with_polygon",
                    test_circle_point_of_contact_with_polygon_4);
    g_test_add_func("/gc/circle_point_of_contact_with_polygon",
    ...
    g_test_add_func("/gc/circle_minimum_translation_vector_with_circle",
                    test_circle_minimum_translation_vector_with_circle_1);
    g_test_add_func("/gc/circle_minimum_translation_vector_with_circle",
                    test_circle_minimum_translation_vector_with_circle_2);
    g_test_add_func("/gc/circle_minimum_translation_vector_with_circle",
                    test_circle_minimum_translation_vector_with_circle_3);
    g_test_add_func("/gc/circle_minimum_translation_vector_with_circle",
                    test_circle_minimum_translation_vector_with_circle_4);
    g_test_add_func("/gc/circle_minimum_translation_vector_with_circle",
                    test_circle_minimum_translation_vector_with_circle_5);
